 ...
 */
public class FichePatientActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        plaies.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int k, long l) {
                ...
                Intent i = new Intent(FichePatientActivity.this,GalerieActivity.class);
        ...
        addPlaie.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                AlertDialog.Builder alertDialog = new AlertDialog.Builder(FichePatientActivity.this);
                alertDialog.setTitle("Nouvelle plaie");
                alertDialog.setMessage("Entrer le nom");

                final EditText input = new EditText(FichePatientActivity.this);
                        ...
                        new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                if (nomPlaie.compareTo("") == 0) {
                                    ...
                                    Intent i = CameraActivity.dispatchTakePictureIntent(FichePatientActivity.this,uriPlaiesPatient);
